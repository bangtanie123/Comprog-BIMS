...
<body class="bg-gray-50 dark:bg-gray-800">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <div data-popover="" id="popover-password" role="tooltip"
                                            ...
                                            <div data-popper-arrow=""
                                                style="position: absolute; left: 0px; transform: translate(139px);">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="flex items-center justify-between py-4">
                                    <div class="flex flex-col flex-grow">
                                        ...
                                        <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send an
                                            email reminding me to rate an item a week after purchase</div>
                                    </div>
                                ...
                                <div class="flex items-center justify-between py-4">
                                    <div class="flex flex-col flex-grow">
                                        ...
                                        <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send user
                                            and product notifications for you</div>
                                    </div>
                                ...
                                <div class="flex items-center justify-between py-4">
                                    <div class="flex flex-col flex-grow">
                                        ...
                                        <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send me an
                                            email when someone comments on one of my items</div>
                                    </div>
                                ...
                                <div class="flex items-center justify-between pt-4">
                                    <div class="flex flex-col flex-grow">
                                        <div class="text-lg font-semibold text-gray-900 dark:text-white">Buyer review
                                            notifications</div>
                                        <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send me an
                                            email when someone leaves a review with their rating</div>
                                    </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/3.0.0/flowbite.min.js"></script>
